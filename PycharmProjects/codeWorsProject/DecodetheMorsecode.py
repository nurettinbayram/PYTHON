...
# traditionally capital letters are used. When the message is written in Morse code, a single space is used
# to separate the character codes and 3 spaces are used to separate words. For example, the message HEY JUDE
# in Morse code is ···· · −·−−   ·−−− ··− −·· ·.
